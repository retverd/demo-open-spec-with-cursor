...
- Как трактовать “текущий день — последний”, если данных за сегодня нет: падать с ошибкой или сохранять частичный набор?
- Требуется ли стандартное имя файла (например, `cbr_usdrub_YYYY-MM-DD.parquet`) и нужна ли дедупликация/перезапись?
- Путь локальной папки фиксированный или настраиваемый (аргумент CLI/конфиг)?
