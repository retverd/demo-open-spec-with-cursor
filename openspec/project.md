...
- **OpenSpec формат**:
  - Требования пишем **по-русски**, но ОБЯЗАТЕЛЬНО используем нормативные маркеры OpenSpec (**MUST**/**SHALL**) в тексте требования (иначе `openspec validate --strict` не пройдёт).
