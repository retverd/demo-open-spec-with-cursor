...
- Упомянуто, что для CI/CD необходимо отделение интеграционных тестов с реальными системами от остальных для снижения влияния внешних факторов на прогон тестов.

❌ Минусы:

- Несмотря на то, что из файла JOURNAL.md он прочитал про Python 3.14.2 и явно это проговорил, в разделе технологии он об этом не упомянул и привел полный предполагаемый список технологий. В итоге раздел `стек` в конституции проекта продублирован.
